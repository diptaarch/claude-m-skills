...
# Specific file
fvm flutter test test/features/auth/data/repositories/auth_repository_impl_test.dart
...
## Coverage & Test Fixing Flow

Follow this workflow to achieve comprehensive test coverage:
...
### Step 3: Fix Tests
Fix the test files based on:
- Current project implementation
- Available skills (use flutter-testing skill guidelines)
...
make -B generate
```
Regenerates mock files after test changes.
...
```bash
# Generate mock files using make
make -B generate
```
